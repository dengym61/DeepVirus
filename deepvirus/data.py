...
class CustomTransformations:
    ...
    def check_transformations(
        ...
        :returns: list of transformation names not satisfying virus requirements.
        """
...
class VirusData:
    ...
    An object of this class is required for model inference with VIRUS.
    """
    def __init__(
        self, 
        # directory,
    ...
    def get_data(
        ...
        if not self.is_valid_instance():
            print("Error: Invalid VirusData instance.")
            raise ValueError
...
#         transform = None):
#         """
#         Initialize a VirusDataset object.

#         :param root: Path to data directory (required).
#         :param data: An instance of the VirusData class (required).
