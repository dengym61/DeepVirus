...
"""
main() module -- VIRUS Command Line tool
"""
...
def init_argparse(
    ...
    parser = argparse.ArgumentParser(
        description="VIRUS Command Line tool."
    )
    if not demo_mode:
    ...
    parser.add_argument('--project_name', type = str, default = "virus_project", help = "project name (output will be saved to output_directory/project_name) (default: 'virus_project')")
...
def main(
    ...
    if args.predict!=None:
        virus_project.predict(args.predict)
